...
At the end of this document, in the appendix section, the code for MATLAB/Simulink modelling and the microcontroller code are provided.

\begin{figure}[h]
    \centering
    \includegraphics[width=1\linewidth]{figures/04_implementation/jamal_01.png}
    %\caption{The self balancing robot}
